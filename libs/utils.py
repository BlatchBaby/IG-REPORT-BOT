...
def print_success(message, *argv):
    print(Fore.RED + "[ NICE ] " + Style.RESET_ALL + Style.BRIGHT, end="")
    print(message, end=" ")
    for arg in argv:
        print(arg, end=" ")
    print("")
...
def print_error(message, *argv):
    print(Fore.RED + "[ ERROR ] " + Style.RESET_ALL + Style.BRIGHT, end="")
    print(message, end=" ")
    for arg in argv:
        print(arg, end=" ")
    print("")
...
def print_status(message, *argv):
    print(Fore.BLACK + "[ * ] " + Style.RESET_ALL + Style.BRIGHT, end="")
    print(message, end=" ")
    for arg in argv:
        print(arg, end=" ")
    print("")
...
def parse_proxy_file(fpath):
    if (path.exists(fpath) == False):
        print("")
        print_error("Proxy file not found! ( NIGGER )")
        print_error("Exiting program")
        exit(0)
    ...
    print("")
    print_success(str(len(proxies)) + " Proxies have been niggered!")
